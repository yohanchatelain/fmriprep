...
class ANTSRPT(ants.ANTS, ReportCapableInterface):
...
class FASTRPT(fsl.FAST, ReportCapableInterface):
...
class BETRPT(fsl.BET, ReportCapableInterface):
...
class FLIRTRPT(fsl.FLIRT, ReportCapableInterface):
